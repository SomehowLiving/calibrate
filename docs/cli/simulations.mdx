...
By default, the evaluation criteria are scored by a text LLM judge. You can override the judge model via an optional top-level `judge` key:

| Key         | Type   | Description                                                                                          |
| ----------- | ------ | ---------------------------------------------------------------------------------------------------- |
| `model`     | string | Model used by the evaluation judge (default: `gpt-5.2-2025-12-11`)                                  |
| `stt_model` | string | Model used by the STT judge in voice simulations (default: `gpt-4.1-2025-04-14`, falls back to `model`) |
