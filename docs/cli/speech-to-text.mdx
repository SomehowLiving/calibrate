...
By default, a text LLM judge evaluates whether each transcription matches the reference text semantically. You can customize the judge model and add multiple evaluation criteria by passing an optional config file with `--config`:
...
| --------------------- | ------ | --------------------------------------------------------------------------- |
| `judge.model`         | string | Model used by the LLM judge (default: `gpt-4.1-2025-04-14`)                |
