...
| `evaluators[].judge_model`   | string | OpenRouter model id for this evaluator (default: `openai/gpt-4o-audio-preview`). Must be an audio-capable model in the [OpenRouter catalog](https://openrouter.ai/models). |
