...
By default, an audio LLM judge evaluates whether each synthesized audio matches the reference text. You can customize the judge model and add multiple evaluation criteria by passing an optional config file with `--config`:
...
| --------------------- | ------ | ------------------------------------------------------------------------------------------ |
| `judge.model`         | string | Model used by the LLM judge (default: `gpt-audio-2025-08-28`). Must be an audio-capable model. |
