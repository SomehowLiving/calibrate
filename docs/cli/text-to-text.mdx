...
By default, response-type test cases are evaluated by a text LLM judge. You can override the judge model via an optional top-level `judge` key:

| Key     | Type   | Description                                                        |
| ------- | ------ | ------------------------------------------------------------------ |
| `model` | string | Model used by the LLM judge (default: `gpt-4.1-2025-04-14`)       |
